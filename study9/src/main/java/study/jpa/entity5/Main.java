...
public class Main {
	...
	private static void save() {
		logic(em -> {
			...
			member.getAddressHistory().add(new Address("서울시", "종로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "을지로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "종로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "을지로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "종로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "을지로", "12345"));
	...
	private static void update() {
		logic(em -> {
			...
			member.getAddressHistory().remove(new Address("서울시", "종로", "12345"));
			member.getAddressHistory().add(new Address("서울시", "종로3가", "12345"));
